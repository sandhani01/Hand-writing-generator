...
export const ADVANCED_GROUPS: ControlGroup[] = [
  ...
  },
  {
    ...
    max: 2.5,
    step: 0.05,
    description: "Stretch or squash letters vertically without changing their width.",
    format: (value) => `${value.toFixed(2)}x`,
  },
  {
    key: "widthMultiplier",
    ...
    max: 2.5,
    step: 0.05,
    description: "Stretch or squash letters horizontally. This changes the aspect ratio of the letters themselves.",
    format: (value) => `${value.toFixed(2)}x`,
  },
    ],
  },
