        ...
        <section className="mode-picker__instructions" aria-label="Mode instructions">
          {!workspace ? (
            <div className="workspace-layout">
              <aside className="workspace-samples">
                <div className="workspace-samples__header">
                  <h3 className="workspace-samples__title">Output Samples</h3>
                  <p className="workspace-samples__desc">Explore real results generated by our App</p>
                </div>
                <div className="workspace-samples__content">
                  <button 
                    className="workspace-samples__btn"
